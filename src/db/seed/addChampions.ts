...
const addChampions = (champions: Champion[]) => {
  ...
  addChampion('Illaoi', ChampionTier.One, images.illaoi, [OriginType.battlecast], [RoleType.brawler])
  addChampion('Nocturne', ChampionTier.One, images.nocturne, [OriginType.battlecast], [RoleType.infiltrator])
  ...
  //addChampion('Lux', ChampionTier.Three, images.lux, [OriginType.darkStar], [RoleType.sorcerer])
  ...
  addChampion('Bard', ChampionTier.Three, images.bard, [OriginType.astro], [RoleType.mystic])
  addChampion('Cassiopeia', ChampionTier.Three, images.cassiopeia, [OriginType.battlecast], [RoleType.mystic])
  addChampion('Vayne', ChampionTier.Three, images.vayne, [OriginType.cybernetic], [RoleType.sniper])
