...
const addItemCombinations = (itemCombinations: ItemCombination[], items: Item[]) => {
  ...
  addItemCombination(ItemType.chainVest, ItemType.spatula, ItemType.vanguard)
  addItemCombination(ItemType.chainVest, ItemType.negatronCloak, ItemType.gargoyle)
  addItemCombination(ItemType.chainVest, ItemType.giantsBelt, ItemType.sunfire)
  ...
  addItemCombination(ItemType.spatula, ItemType.negatronCloak, ItemType.elderwood)
  addItemCombination(ItemType.spatula, ItemType.giantsBelt, ItemType.frozenMallet)
  addItemCombination(ItemType.spatula, ItemType.bfSword, ItemType.sword)
  addItemCombination(ItemType.spatula, ItemType.recurveBow, ItemType.botrk)
  addItemCombination(ItemType.spatula, ItemType.sparringGloves, ItemType.ghostblade)
  addItemCombination(ItemType.spatula, ItemType.largeRod, ItemType.dusk)
