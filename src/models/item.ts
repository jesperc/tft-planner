...
const itemTypeToStringLut: Map<ItemType, string> = new Map([
  ...
  [ItemType.gargoyle, 'Gargoyle'],
  [ItemType.sunfire, 'Sunfire'],
  [ItemType.duelist, 'Duelist'],
  [ItemType.elderwood, 'Elderwood'],
  [ItemType.mage, 'Mage'],
  [ItemType.dusk, 'Mantle of Dusk'],
  [ItemType.sword, 'Divine'],
  [ItemType.vanguard, 'Vanguard'],
  [ItemType.warlord, 'Warlord'],
  [ItemType.youmuu, 'Assassin'],
])
